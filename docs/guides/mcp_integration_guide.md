...
Execute `tools/list` em cada conexão. O [catálogo técnico](../development/tool_catalog.md) contém a visão de
...
[catálogo de ferramentas](../development/tool_catalog.md).
...
4. Verifique que `initialize` retorna RadIA `2.17.13`.
