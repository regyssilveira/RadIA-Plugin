...
BPL API documented in the [extension guide](../development/tool_extension_guide.en.md) and remain subject to central
...
The functional matrix is validated by automated tests and evidence published in GitHub Releases.
...
[Remote extension catalog](../reference/extension_catalog.en.md).
