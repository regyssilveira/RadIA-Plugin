# Manual completo do RadIA 2.14.0
...
`Rad IA Chat v2.14.0`, para facilitar suporte e conferência de instalação.
...
- O [catálogo gerado do runtime](../reference/runtime_tool_catalog.md) lista as 164 tools internas registradas.
