...
Consulte [O que faz e quando usar cada ferramenta](internal_tools_reference.md) para os contratos
operacionais e [Catálogo gerado](runtime_tool_catalog.md) para a lista registrada na build.
