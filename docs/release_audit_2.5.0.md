...
| Gate | Resultado |
|---|---|
| Delphi 12 Win32 | Compilação e 1.035 testes aprovados, zero leaks |
| Delphi 13 Win32 | Compilação e 1.035 testes aprovados, zero leaks |
...
obtidos das fontes oficiais; nenhuma CLI de terceiros é incorporada ao instalador.
