# Manual completo do RadIA 2.7.0
...
`Rad IA Chat v2.7.0`, para facilitar suporte e conferência de instalação.
...
- O [catálogo gerado do runtime](runtime_tool_catalog.md) lista as 132 tools internas registradas.
