...
| **Unified Delphi code validation** | Intelligence | Consolidates native rules, compiler messages, DelphiLint diagnostics, and Sonar issues into navigable findings while distinguishing code defects, missing optional sources, and configuration errors. | 🚧 In progress |
