...
See [native and CLI executors](../guides/cli_executors.en.md) and [MCP integration](../guides/mcp_integration_guide.en.md).
...
[Project, session, and request settings](../guides/hierarchical_settings.en.md) for precedence, formats,
...
See the [FastMM5 memory diagnostics guide](../guides/fastmm5_diagnostic_session.en.md).
...
For guided usage, return to the [user manual](../guides/user_manual.en.md). For scoped overrides, see
[project, session, and request settings](../guides/hierarchical_settings.en.md). For failures, use
[troubleshooting](../guides/troubleshooting_agentic_platform.en.md).
