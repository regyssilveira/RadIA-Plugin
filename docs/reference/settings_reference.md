...
consulte o [manual do usuário](../guides/user_manual.md); para problemas, consulte a
[solução de problemas](../guides/troubleshooting_agentic_platform.md).
...
[Orquestração nativa e executores por CLI](../guides/cli_executors.md). Para formatos e descoberta, consulte
...
[Configurações por projeto, sessão e solicitação](../guides/hierarchical_settings.md) para precedência,
...
Consulte o [guia do diagnóstico de memória](../guides/fastmm5_diagnostic_session.md) antes da
primeira sessão.
...
|---|---|
| Primeiros passos | [Manual do usuário](../guides/user_manual.md) |
| Todas as capacidades | [Mapa de capacidades](capabilities.md) |
| Ferramentas e consentimento | [Guia das ferramentas agentivas](../guides/user_guide_agentic_tools.md) |
| Comandos do chat | [Comandos de barra](slash_commands.md) |
| Configurações por projeto, sessão ou solicitação | [Configurações por escopo](../guides/hierarchical_settings.md) |
| Erros e recuperação | [Solução de problemas](../guides/troubleshooting_agentic_platform.md) |
