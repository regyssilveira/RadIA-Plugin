...
* `docs/project/backlog.md` e `docs/project/backlog.en.md`: somente trabalho ainda aberto.
* `docs/project/roadmap.md` e `docs/project/roadmap.en.md`: direção futura, sem histórico da release.
* GitHub Releases: notas, artefatos e evidências específicas da versão.
...
dos ZIPs e BPLs, os 10 ciclos aprovados por target, a faixa de duração, o catálogo histórico de 95 tools,
...
O gate exige exatamente os três targets suportados, 148 ferramentas e o workflow
...
O gate exige exatamente Delphi 12 Win32, Delphi 13 Win32 e Delphi 13 IDE64, todos com 148
...
Publique somente o instalador. A versão 2.8.0 não possui atualização automática e não publica
`stable.json`. O fluxo completo está em [Instalador visual](../getting-started/visual_installer.md).
...
* Instalador visual e SHA-256 publicados.
