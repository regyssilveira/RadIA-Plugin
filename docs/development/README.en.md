...
- [General architecture](architecture_guide.en.md)
- [Agentic architecture](agentic_architecture.en.md)
- [Source code guide](source_code_guide.en.md)
- [Architectural tool catalog](tool_catalog.en.md)
- [Extension API](tool_extension_guide.en.md)
- [New provider guide](new_provider_guide.en.md)
- [Branch convention](branch_convention.en.md)
