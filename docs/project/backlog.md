...
conexão completa desse plano ao runner MCP/IDE real e a coleta das evidências runtime. Dez cenários
já estão conectados e aprovados nos três targets, totalizando 30 execuções reais: inventário,
...
falho. Ainda faltam conectar os outros seis cenários e substituir a entrada SQL controlada do smoke
pela captura real da seleção no editor.
