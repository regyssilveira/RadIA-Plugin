...
conexão completa desse plano ao runner MCP/IDE real e a coleta das evidências runtime. Onze cenários
já estão conectados e aprovados nos três targets, totalizando 33 execuções reais: inventário,
...
falho, além da correção consentida de accessor de parâmetro com Smart Diff, build e DUnitX. Ainda
faltam conectar os outros cinco cenários e substituir a entrada SQL controlada do smoke pela captura
