...
conexão completa desse plano ao runner MCP/IDE real e a coleta das evidências runtime. Oito cenários
seguros já estão conectados e aprovados nos três targets, totalizando 24 execuções reais: inventário,
...
com aplicação negada. Ainda faltam conectar os outros oito cenários e substituir a entrada SQL
