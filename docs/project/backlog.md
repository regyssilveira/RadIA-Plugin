...
conexão completa desse plano ao runner MCP/IDE real e a coleta das evidências runtime. Doze cenários
já estão conectados e aprovados nos três targets, totalizando 36 execuções reais: inventário,
...
preview obsoleto sem sobrescrever uma mudança posterior. Ainda faltam conectar os outros quatro
cenários e substituir a entrada SQL controlada do smoke pela captura real da seleção no editor.
