...
Fourteen scenarios are connected and passing on all three targets, producing 42 real executions:
...
legacy source. The other two scenarios remain to be connected, and the smoke's controlled SQL input
must be replaced with a real editor selection.
