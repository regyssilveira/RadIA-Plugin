...
Este é o ponto de entrada da documentação do RadIA 2.4.0. Escolha primeiro o que você deseja
...
| Revisar a candidata 2.4.0 | [Notas de release](release_notes_2.4.0.md) |
...
- [goal ativo de portabilidade de skills e terminal](terminal_skill_portability_goal.md);
