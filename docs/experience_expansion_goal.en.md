...
| M3 | Visual chat session with before/after captures, timeline, and validation driven by real events | PNG capture and card delivered; scenario events and real matrix pending |
