...
O gate gera `terminal_high_fidelity_evidence_2.4.1.json`; ele complementa, mas não substitui, o
...
O resultado vigente fica em `terminal_smoke_evidence_2.4.1.json`. O arquivo 2.0.0 permanece como
