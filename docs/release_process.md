...
O gate exige exatamente os três targets suportados, 133 ferramentas e o workflow
...
O gate exige exatamente Delphi 12 Win32, Delphi 13 Win32 e Delphi 13 IDE64, todos com 133
...
`stable.json`. O fluxo completo está em [Instalador visual](visual_installer.md).
