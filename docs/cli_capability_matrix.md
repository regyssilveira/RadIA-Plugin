...
> **Baseline:** RadIA 2.4.0, atualizada em 10 de agosto de 2026.
...
| Executor | Saída estruturada | ID de sessão | Retomada estável | Modelo | MCP | FIM dedicado | Uso no RadIA 2.4.0 |
|---|---:|---:|---:|---:|---:|---:|---|
