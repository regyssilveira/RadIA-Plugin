...
> **Baseline:** RadIA 2.7.0, atualizada em 11 de agosto de 2026.
...
| Executor | Saída estruturada | ID de sessão | Retomada estável | Modelo | MCP | FIM dedicado | Uso no RadIA 2.7.0 |
|---|---:|---:|---:|---:|---:|---:|---|
