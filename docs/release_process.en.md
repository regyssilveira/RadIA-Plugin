...
Visual acceptance requests a native editor repaint and passes only when the real OTA callback
confirms that completion and reviews reached the paint cycle.
