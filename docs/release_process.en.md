...
The gate creates `terminal_high_fidelity_evidence_2.4.2.json`; it complements but does not replace
...
The current result is stored in `terminal_smoke_evidence_2.4.2.json`. The 2.0.0 file remains the
