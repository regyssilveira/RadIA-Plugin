...
o gate atual também exige aceite, um único undo restaurando o snapshot e rejeição limpa. A matriz
aprovada está publicada em `inline_completion_smoke_evidence_2.3.1.json`.
