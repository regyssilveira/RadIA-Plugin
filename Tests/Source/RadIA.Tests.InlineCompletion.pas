...
begin
  ...
  Assert.AreEqual<Integer>(2, Length(LContext.Imports));
...
begin
  ...
  Assert.AreEqual<Integer>(0, Length(LContext.NearbySymbols));
end;
...
begin
  ...
  Assert.AreEqual<Integer>(2, Length(LContext.Imports));
  Assert.AreEqual<Integer>(1, Length(LContext.NearbySymbols));
end;
